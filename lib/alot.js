...
var AsyncPool = /** @class */ (function () {
    function AsyncPool(stream, threads) {
...
var AlotProto = /** @class */ (function () {
    ...
    AlotProto.prototype.toArrayAsync = function (meta) {
        ...
        this.reset();
        var pool = new Pool_1.AsyncPool(this, meta.threads);
        return pool.start();
    };
    AlotProto.prototype.first = function () {
...
var MapStream = /** @class */ (function (_super) {
    ...
    MapStream.prototype.next = function () {
        ...
        return {
            value: this.fn(result.value, result.index),
            done: false
        };
    };
...
var TakeStream = /** @class */ (function (_super) {
    ...
    function TakeStream(stream, count) {
        var _this = _super.call(this, stream) || this;
        _this.stream = stream;
        _this.count = count;
        _this._took = 0;
...
var SkipStream = /** @class */ (function (_super) {
    ...
    function SkipStream(stream, count) {
        var _this = _super.call(this, stream) || this;
        _this.stream = stream;
        _this.count = count;
        _this._skipped = 0;
...
var GroupByStream = /** @class */ (function (_super) {
    ...
    GroupByStream.prototype.next = function () {
        if (this.groups) {
            ...
            return { done: false, value: this.groups[this.index] };
        }
        this.groups = [];
        ...
        while (true) {
            ...
            var key = String(this.fn(result.value, result.index));
            var arr = this.hash[key];
            if (arr == null) {
                arr = this.hash[key] = [];
                this.groups.push({ key: key, values: arr });
            }
...
var DistinctByStream = /** @class */ (function (_super) {
    ...
    function DistinctByStream(stream, fn) {
        ...
        _this.stream = stream;
        _this.fn = fn;
        _this._hash = Object.create(null);
        _this._index = -1;
        return _this;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
_src_streams_FilterStream;
_src_streams_MapStream;
_src_streams_SkipStream;
_src_streams_TakeStream;
_src_streams_GroupStream;
var AlotProto_1 = _src_AlotProto;
...
var Alot = /** @class */ (function (_super) {
    ...
    var Alot_1;
    Alot.default = Alot_1;
    Alot = Alot_1 = __decorate([
        classify_1.Classify
    ], Alot);
    return Alot;
}(alot_1.Alot));
exports.Alot = Alot;
exports.default = Alot;
