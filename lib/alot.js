...
var AlotProto = /** @class */ (function () {
    ...
    AlotProto.prototype.count = function (fn) {
        var _a;
        this.reset();
        if (this.isAsync) {
            return this.countAsync(fn);
        }
        var count = 0;
        var i = 0;
        while (true) {
            ...
            count += (_a = fn(entry.value, i++), (_a !== null && _a !== void 0 ? _a : 0));
        }
        return count;
    };
    AlotProto.prototype.countAsync = function (fn) {
        var _a;
        return __awaiter(this, void 0, Promise, function () {
            var count, i, entry, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        count = _b + (_a = (_c.sent()), (_a !== null && _a !== void 0 ? _a : 0));
                        return [3 /*break*/, 1];
