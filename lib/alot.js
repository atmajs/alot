...
var AlotProto = /** @class */ (function () {
    ...
    AlotProto.prototype.join = function (inner, getKey, getForeignKey, joinFn) {
        return new JoinStream_1.JoinStream(this, inner, getKey, getForeignKey, joinFn, 'inner');
    };
    /** Join Full Outer  */
    AlotProto.prototype.joinOuter = function (inner, getKey, getForeignKey, joinFn) {
        return new JoinStream_1.JoinStream(this, inner, getKey, getForeignKey, joinFn, 'outer');
    };
