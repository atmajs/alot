...
var SortByStream = /** @class */ (function (_super) {
    ...
    function SortByStream(stream, mix, direction, isAsync) {
        ...
        _this.arr = null;
        _this.index = -1;
        _this.sortByFn = Utils.createSortMethod(mix);
        _this.nextAsync = deco_1.Deco.createQueuedMethod(_this.nextAsync);
    ...
    SortByStream.prototype.thenBy = function (mix, direction) {
        var _a;
        if (direction === void 0) { direction = 'asc'; }
...
(function (Utils) {
    function createSortMethod(mix) {
        if (typeof mix === 'string') {
            var path_1 = mix;
            return function (x) { return (0, obj_1.obj_getProperty)(x, path_1); };
        }
        return mix;
    }
    ...
    function sort(arr, getValueFn, direction, thenMethods) {
        var mapped = getKeyValues(arr, getValueFn);
        var thenMapped = thenMethods === null || thenMethods === void 0 ? void 0 : thenMethods.map(function (_a) {
            var getValueFn = _a[0], direction = _a[1];
            return [getKeyValues(arr, getValueFn), direction];
        });
        mapped.sort(function (a, b) {
            if (a.key === b.key) {
    ...
    function compare(a, b, thenMappedArr, thenI) {
        ...
        var _a = thenMappedArr[thenI], thenMapped = _a[0], direction = _a[1];
        var thenA = thenMapped[a.i];
        var thenB = thenMapped[b.i];
